...
import { Package, Cpu, ArrowRight, CheckCircle2, Shirt, Sparkles, Building2 } from "lucide-react";
...
const OrderRoutingDemo = () => {
  ...
  useEffect(() => {
    const runAnimation = () => {
      ...
      const timers = [
        ...
        setTimeout(() => setPhase("routing"), 2500),
        setTimeout(() => {
          setPhase("complete");
  ...
  return (
    <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl p-8 overflow-hidden border border-white/10">
      {/* Background grid */}
      ...
      <div className="relative z-10">
        ...
        {/* Main visualization */}
        <div className="grid grid-cols-3 gap-6 items-center min-h-[300px]">
          ...
          <div className="flex flex-col items-center justify-center">
            <AnimatePresence mode="wait">
              ...
              {phase === "routing" && (
                ...
                >
                  <motion.div 
                    className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-500/50 flex items-center justify-center mb-4 mx-auto"
                  >
                    <motion.div
                      animate={{ x: [0, 10, 0] }}
              ...
              {phase === "complete" && (
                ...
                >
                  ...
                  <div className="text-xs text-white/40 mt-1">
                    Sent to {currentOrder.decorator}
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
