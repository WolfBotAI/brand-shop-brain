  ...
  return (
    <div
      ...
      style={{
        ...
        ["--sf-primary" as string]: theme.primary,
        ["--sf-secondary" as string]: theme.secondary,
        ["--sf-accent" as string]: theme.accent,
        ["--sf-bg" as string]: theme.background,
      }}
    >
      {/* Store Header */}
      <div
      ...
      <div className="p-4 grid grid-cols-2 sm:grid-cols-3 gap-4" style={{ backgroundColor: theme.background }}>
        {products.map((product) => (
          ...
          >
            {product.styleImage ? (
              <img src={product.styleImage} alt={product.title} className="w-full h-32 object-cover" loading="lazy" />
            ) : (
            ...
            <div className="p-3 space-y-2">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm font-bold" style={{ color: theme.primary }}>
                  ${(product.piecePrice || 0).toFixed(2)}
                </span>
