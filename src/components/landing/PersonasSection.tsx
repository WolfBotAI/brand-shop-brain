...
const personas = [
  {
    icon: Store,
    title: "Distributors",
    summary: "Client sites scattered across platforms, pricing and catalogs you update by hand, orders split across a dozen suppliers. We connect it all and answer the status calls for you.",
  ...
  },
  {
    icon: Printer,
    title: "Decorators",
    summary: "Every PO in a different format, half of them incomplete, and a phone that never stops ringing. AI Vision reads them; our AI receptionist handles the calls.",
    href: "/for/decorators",
  ...
  },
  {
    ...
    summary: "Entrepreneurs, agencies, and influencers: offer B2B merch stores under your brand and earn up to 40% on apparel and recurring subscriptions.",
